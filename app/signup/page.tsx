      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>Join RentPe to start renting or listing items</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => handleInputChange("userType", value)}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="owner">List my items for rent</SelectItem>
                    <SelectItem value="both">Both rent and list items</SelectItem>
                  </SelectContent>
                </Select>
              </div>
